...
if os.path.exists("occ.txt") == True :
    ...
    with open("plug-in_deploy.txt", "r", encoding="utf-8") as f:
        f.write("/love\n"
                "@爱你哟\n"
                "$’爱你哟‘\n\n"
...
importbase ="from nonebot import *\n" \
...
with open(fixpy, "w", encoding='utf-8') as f:
    if c == "off":
        f.write(importbase)
    if c == "on":
        f.write(importing)
...
def read_target(target_file_= target_file):
    ...
    with open(fixpy, "a", encoding='utf-8') as f:
